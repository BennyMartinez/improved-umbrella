...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
         <asp:Panel runat="server" CssClass="">    
             <h1><b>Empleado</b></h1>        
             <asp:GridView ID="gvEmpleado" runat="server" CellSpacing="0" Width="100%" CssClass=" display table-bordered" ClientIDMode="Static" OnSelectedIndexChanged="gvEmpleado_SelectedIndexChanged">
                 <Columns>
                     <asp:TemplateField>
                         <HeaderTemplate><asp:LinkButton runat="server" ID="lAgregar" ClientIDMode="Static" OnClick="lAgregar_Click"><i class="glyphicon glyphicon-plus"></i></asp:LinkButton></HeaderTemplate>
                         <ItemTemplate><asp:LinkButton ID="lModificar" CommandName="Select" runat="server" ><i class="glyphicon glyphicon-pencil"></i></asp:LinkButton></ItemTemplate>
                     </asp:TemplateField>
                 </Columns>
             </asp:GridView>             
         </asp:Panel>
                ...
                <div class="modal-dialog">    
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <asp:Button runat="server" CssClass="btn btn-success" ID="btnAgregar" OnClick="btnAgregar_Click"/>
                    </div>
                  </div>      
                </div>
              </div>
